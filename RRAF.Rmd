...
summary_attempt <- tibble(mean_MPA_2012, mean_MPA_2018, mean_nonMPA_2012, mean_nonMPA_2018, sd_MPA_2012, sd_MPA_2018, sd_nonMPA_2012, sd_nonMPA_2018, n_mpa_2012, n_mpa_2018, n_nonMPA_2012, n_nonMPA_2018)



means <- c(mean_MPA_2012, mean_MPA_2018, mean_nonMPA_2012, mean_nonMPA_2018)
sds <- c(sd_MPA_2012, sd_MPA_2018, sd_nonMPA_2012, sd_nonMPA_2018)
ns <- c(n_mpa_2012, n_mpa_2018, n_nonMPA_2012, n_nonMPA_2018)

summary_try <- tibble(means, sds, ns) %>% 
  kable(col.names = c("Mean Size (mm)", 
                     "Standard Deviation", 
                     "Sample Size (n)")
        ) %>% 
  ...
  add_header_above(c("Summary" = 3))

summary_try

## HI Rachel! This "summary_try" is slightly closer to a table, but alas... it's not quite what we want. I love it!!! 
